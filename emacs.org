...
#+BEGIN_SRC  emacs-lisp
  ...
  (deftheme chaseadamsio "A dark colour theme")
  ...
  (let ((color-bg     "background")
	...
	(color-06 "cyan")
	(color-07 "white")
	(color-08 "brightblack")
	(color-09 "brightred")
	(color-0A "brightgreen")
	(color-0B "brightyellow")
	(color-0C "brightblue")
	(color-0D "brightmagenta")
	(color-0E "brightcyan")
	(color-0F "brightwhite"))

    (custom-theme-set-faces
     'chaseadamsio

     `(default ((t (:background ,color-bg :foreground ,color-fg))))
     `(cursor  ((t (:background ,color-bg))))
     `(highlight ((t (:background ,color-08))))
     `(region ((t (:background ,color-09))))
     `(hl-line ((t (:background ,color-08))))
     `(error ((t (:foreground ,color-01))))
     `(success ((t (:foreground ,color-02))))
     `(fringe ((t (:background ,color-08))))
     `(secondary-selection ((t (:background ,color-08))))
     `(mode-line ((t (:background ,color-08 :foreground ,color-0B))))
     `(mode-line-inactive ((t (:background ,color-bg :foreground ,color-0B))))
     `(mode-line-buffer-id ((t (:box nil :foreground ,color-fg))))
     `(trailing-whitespace ((t (:background ,color-01))))    
     `(font-lock-keyword-face ((t (:foreground ,color-05)))) 
     `(font-lock-string-face ((t (:foreground ,color-02)))) 
     `(font-lock-builtin-face ((t (:foreground ,color-02)))) 
     `(font-lock-comment-face ((t (:foreground ,color-0B)))) 
     `(font-lock-color-constant-face ((t (:foreground ,color-02)))) 
     `(font-lock-function-name-face ((t (:foreground ,color-04)))) 
     `(font-lock-variable-name-face ((t (:foreground ,color-04)))) 
     `(font-lock-type-face ((t (:foreground ,color-05)))) 
     `(show-paren-match-face ((t (:foreground ,color-04)))) 
     `(show-paren-mismatch-face ((t (:foreground ,color-01)))) 
     ;; org-mode
     `(org-document-title ((t (:height 1.2 :foreground ,color-06))))
     `(org-document-info-keyword ((t (:foreground ,color-0B))))
     `(org-level-1 ((t (:foreground ,color-04))))
     `(org-level-2 ((t (:foreground ,color-02))))
     `(org-level-3 ((t (:foreground ,color-06))))
     `(org-level-4 ((t (:foreground ,color-05))))
     `(org-level-5 ((t (:foreground ,color-01))))
     `(org-level-6 ((t (:foreground ,color-03))))
     `(org-link ((t (:foreground ,color-06))))
     `(linum ((t (:foreground ,color-0B))))
     ))
#+END_SRC
