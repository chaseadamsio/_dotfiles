...
#+BEGIN_SRC emacs-lisp
  (use-package org-kanban
    :ensure t)
#+END_SRC
* Setup [[https://github.com/seudut/perspeen][Perspeen]]
window management for emacs
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package general
    ...
    (general-define-key
     ...
     "s" '(nil :which-key "workspace")
     "sc" '(perspeen-create-ws :which-key "create workspace")
     "sd" '(perspeen-change-root-dir :which-key "set directory root")
     "sk" '(perspeen-delete-ws :which-key "kill workspace")
     "sn" '(perspeen-next-ws :which-key "next workspace")
     "sp" '(perspeen-previous-ws :which-key "previous workspace")
     "sr" '(perspeen-rename-ws :which-key "rename workspace")
